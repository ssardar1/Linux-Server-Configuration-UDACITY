...
You can visit http://35.165.36.12 for the website deployed.
...
4. In your terminal, type in
	```ssh -i ~/.ssh/udacity_key.rsa root@35.165.36.12```
...
4. now you can use ssh to login with the new user you created
	...
	`ssh -i [privateKeyFilename] grader@35.165.36.12`
...
5. Clone the Catalog App to the virtual machine `git clone https://github.com/ssardar1/Item_Catalog_UDACITY.git`
...
2. Add the following lines of code to the file to configure the virtual host. 
	...
	```
	<VirtualHost *:80>
		ServerName 35.165.36.12
		ServerAdmin ssardar@gmail.com
